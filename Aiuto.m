...
MostraAiuto[a_Integer, b_Integer] := Module[
 ...
 Panel[
   Column[{
    ...
    "Immagina di divere il numero totale di palline " <> ToString[a] <> " (pari al dividendo) nel maggiore numero di gruppo possibili di " <> ToString[b] <> " palline (divisore). Il numero di gruppi formatosi di " <> ToString[b] <> " palline \[EGrave] il risultato della divisione. Le palline rimanenti dalla divisione in gruppi uguali \[EGrave] il resto"
